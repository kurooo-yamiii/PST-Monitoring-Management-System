...
<body>
<form action="pstadd.php?AccID=<?=$_GET['AccID']?>" method="post">
            <?php
			...
			<p>Student (Pre-Service Teacher Account)</p><br>
			<p class="accumulated">Pre-Service Teacher has a total of <?php echo $rowCount?> accounts created</p>
			<?php 
			...
			<table class="table table-striped">
			  ...
			  // Continue adding rows depening to the Fetch Data
			    ...
			    <tr>
                  ...
                  <td><a href="pstdelq.php?ID=<?=$rows['ID']?>&AccID=<?php echo $_GET['AccID']; ?>" 
			      	     class="red-button">Delete</a>
                           <a href="pstup.php?ID=<?=$rows['ID']?>&AccID=<?php echo $_GET['AccID']; ?>" 
            ...
            <button type="submit">Add Student Account</button>
